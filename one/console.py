...
Function: Creating an instance of the class
        '''
...
Function: Showing instance details of the class
        '''
...
Function: Deleting the instance  of the class
        '''
        # check if class name and instance id was provided
        if line == "" or line is None:
            print("** class name missing **")
...
Function: Printing string representation of all instances
        '''
...
Function: Updating instance of the class
        '''
...
Function: Counting all instances  of the class
        '''
        count = 0
