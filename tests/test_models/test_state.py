...
class TestState_instantiation(unittest.TestCase):
    """Unittests to testing instantiation of the State class."""
...
class TestState_save(unittest.TestCase):
    """Unittests to testing save method of the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittests to testing to_dict method of the State class."""
