...
class TestReview_instantiation(unittest.TestCase):
    """Unittests to testing instantiation of the Review class."""
...
class TestReview_save(unittest.TestCase):
    """Unittests to testing save method of the Review class."""
...
class TestReview_to_dict(unittest.TestCase):
    """Unittests to testing to_dict method of the Review class."""
