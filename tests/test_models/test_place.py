...
class TestPlace_instantiation(unittest.TestCase):
    """Unittests to testing instantiation of the Place class."""
...
class TestPlace_save(unittest.TestCase):
    """Unittests to testing save method of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests to testing to_dict method of the Place class."""
