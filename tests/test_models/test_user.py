...
class TestUser_instantiation(unittest.TestCase):
    """Unittests to testing instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """Unittests to testing save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests to testing to_dict method of the User class."""
