...
class TestCity_instantiation(unittest.TestCase):
    """Unittests to testing instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """Unittests to testing save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests to testing to_dict method of the City class."""
